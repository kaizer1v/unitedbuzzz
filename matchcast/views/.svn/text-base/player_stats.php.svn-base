...
<div class='wrap nosubsub'>
	<h2>Commentaries</h2>
		...
		<tbody>
		<?php
			$commenturl = get_option('siteurl').'/wp-admin/edit.php?post_type=matchcast&page=playerstats&playerStatsId=';
			foreach($allposts as $posts)
			{
			 ?>
				<tr>
					...
					<td>
						<a href="<?php echo $commenturl.$globalid ?>&pid=<?php echo $posts->ID ?> ">Player Stats</a>
					</td>
				</tr>
			<?php	
			}
