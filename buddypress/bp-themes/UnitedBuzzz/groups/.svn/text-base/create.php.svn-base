			...
			<div class="item-body" id="group-create-body">
				...
				<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
					...
					<table id="create-group-table">
						<tr>
							<td><label for="group-name"><?php _e('* Group Name', 'buddypress') ?> <?php _e( '(required)', 'buddypress' )?></label></td>
							<td><input type="text" name="group-name" class="inputbox-common-class create-group-name" id="group-name" value="<?php bp_new_group_name() ?>" /></td>
						</tr>
						<tr>
							<td><label for="group-desc"><?php _e('* Group Description', 'buddypress') ?> <?php _e( '(required)', 'buddypress' )?></label></td>
							<td><textarea name="group-desc" class="inputbox-common-class create-group-desc" id="group-desc"><?php bp_new_group_description() ?></textarea></td>
						</tr>
					</table>
					...
					<?php if ( !bp_get_avatar_admin_step() ) : ?>
						...
						<div class="main-column">
							...
							<p>
								...
								<input type="submit" name="upload" class="new-topic-ajax-button" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ) ?>" />
				...
				<?php if ( bp_is_group_creation_step( 'group-invites' ) ) : ?>
					...
					<?php if ( function_exists( 'bp_get_total_friend_count' ) && bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
						<div class="left-menu">
							...
							<div id="invite-list">
								<ul id="create-group-invite-list">
				...
				<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
					<div class="submit" id="previous-next">
						...
						<?php if ( !bp_is_first_group_creation_step() ) : ?>
							<input type="button" class="new-topic-ajax-button" value="&larr; <?php _e('Previous Step', 'buddypress') ?>" id="group-creation-previous" name="previous" onclick="location.href='<?php bp_group_creation_previous_link() ?>'" />
						<?php endif; ?>

						<?php /* Next Button */ ?>
						<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
							<input type="submit" class="new-topic-ajax-button" value="<?php _e('Next Step', 'buddypress') ?> &rarr;" id="group-creation-next" name="save" />
						<?php endif;?>

						<?php /* Create Button */ ?>
						<?php if ( bp_is_first_group_creation_step() ) : ?>
							<input type="submit" class="new-topic-ajax-button" value="<?php _e('Create Group and Continue', 'buddypress') ?> &rarr;" id="group-creation-create" name="save" />
						<?php endif; ?>

						<?php /* Finish Button */ ?>
						<?php if ( bp_is_last_group_creation_step() ) : ?>
							<input type="submit" class="new-topic-ajax-button" value="<?php _e('Finish', 'buddypress') ?> &rarr;" id="group-creation-finish" name="save" />
						<?php endif; ?>
					</div>
				<?php endif;?>
