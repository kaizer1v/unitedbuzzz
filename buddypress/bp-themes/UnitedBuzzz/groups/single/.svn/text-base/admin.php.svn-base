...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<input type="text" class="inputbox-common-class" name="group-name" id="group-name" value="<?php bp_group_name() ?>" />
	<br />
	<label for="group-desc" class="group-desc-label">* <?php _e( 'Group Description', 'buddypress' ) ?></label>
	<textarea name="group-desc" class="inputbox-common-class" id="group-desc"><?php bp_group_description_editable() ?></textarea>
	...
	<p><input type="submit" class="new-topic-ajax-button" value="<?php _e( 'Save Changes', 'buddypress' ) ?> &rarr;" id="save" name="save" /></p>
...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<div class="radio" id="setting-radio">
		<label>
...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p>
				...
				<input type="submit" class="new-topic-ajax-button" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ) ?>" />
	...
	<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
		...
		<input type="submit" class="new-topic-ajax-button" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ) ?>" />
...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<div class="bp-widget group-admin-member-management">
...
<?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
	...
	<div class="submit">
		<input type="submit" disabled="disabled" class="new-topic-ajax-button" value="<?php _e( 'Delete Group', 'buddypress' ) ?> &rarr;" id="delete-group-button" name="delete-group-button" />
	</div>
