<div id="center-content-div-wrapper" >
	<div id="center-content-div" >
		...
		<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
			...
			<p><?php _e( 'Your avatar will be used on your profile and throughout the site. If there is a <a style="color:#b00409" href="http://gravatar.com">Gravatar</a> associated with your account email we will use that, or you can upload an image from your computer.', 'buddypress') ?></p>
			...
			<form action="" method="post" id="avatar-upload-form" enctype="multipart/form-data">
				...
				<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<p id="avatar-upload">
						...
						<input type="submit" name="upload" id="upload" class="create-event" value="<?php _e( 'Upload Image', 'buddypress' ) ?>" />
						<input type="hidden" name="action" id="action" value="bp_avatar_upload" />
						<div class="clear">&nbsp;</div>
						<span>&nbsp;(Image Size Cannot Exceed 1 MB)</span>
					</p>
				...
				<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<input type="submit" name="avatar-crop-submit" class="create-event" id="avatar-crop-submit" value="<?php _e( 'Crop and continue', 'buddypress' ) ?>" />
