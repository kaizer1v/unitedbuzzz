		...
		<form id="send-reply" action="<?php bp_messages_form_action() ?>" method="post" class="standard-form">
			...
			<div class="message-box">
				...
				<div class="message-content">
					...
					<textarea name="content" class="inputbox-common-class message_content_single" id="message_content" rows="15" cols="40"></textarea>

					<?php do_action( 'bp_after_message_reply_box' ) ?>

					<div class="submit send-message-submit-wrapper">
						<input type="submit" name="send" class="new-topic-ajax-button" value="<?php _e( 'Send Reply', 'buddypress' ) ?> &rarr;" id="send_reply_button"/>
