            ...
            <div class="comment" id="comment-<?php comment_ID(); ?>">
				...
				<div class="news-image-wrapper">
                	...
                	<?php if ( $comment->user_id ) : ?>
                		...
                		<?php echo bp_core_fetch_avatar( array( 'item_id' => $comment->user_id, 'width' => 60, 'height' => 53, 'email' => $comment->comment_author_email ) ); ?>
                		</a>
                	<?php else : ?>
                		<?php echo get_avatar( $comment, 50 ) ?>
                	<?php endif; ?>
                	</div><!--END .news-image-->
                </div><!--END .news-image-wrapper-->
                ...
                <div class="comment-content">
		            ...
		            <div class="text">
		  	            ...
		  	            <div class="comment-options">
		  	            	<?php echo comment_reply_link( array('depth' => (isset($depth)?$depth:''), 'max_depth' => (isset($args['max_depth'])?$args['max_depth']:'') ) ) ?>
			...
			<form action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post" id="commentform" class="standard-form">
				...
				<?php else : ?>
					...
					<p class="form-author">
						...
						<input type="text" class="text-input inputbox-common-class" name="author" id="author" value="<?php echo $comment_author; ?>" size="40" tabindex="1" />
					</p>

					<p class="form-email">
						<label for="email"><?php _e('Email', 'buddypress'); ?>  <?php if ( $req ) : ?><span class="required"><?php _e('*', 'buddypress'); ?></span><?php endif; ?></label>
						<input type="text" class="text-input inputbox-common-class" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="40" tabindex="2" />
					</p>

					<p class="form-url">
						<label for="url"><?php _e('Website', 'buddypress'); ?></label>
						<input type="text" class="text-input inputbox-common-class" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="40" tabindex="3" />
					</p>
				...
				<p class="form-textarea">
					...
					<textarea name="comment" id="comment" class="inputbox-common-class" cols="40" rows="2" tabindex="4"></textarea>
				</p>

				<?php do_action( 'bp_blog_comment_form' ) ?>

				<p class="form-submit">
					<input class="new-topic-ajax-button submit-comment button" name="submit" type="submit" id="submit" tabindex="5" value="Comment" />
					<!--<input class="new-topic-ajax-button submit-comment button" name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Submit', 'buddypress'); ?>" />-->
