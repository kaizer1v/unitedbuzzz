		...
		?>
			<div id="player-tabs">
				<ul>
					...
					<li><a class="activePage" href="<?php echo bloginfo('url'); ?>/top-scorers-<?php echo $lntType; ?>?lnt_type_slug=<?php echo $lntType; ?>">Top Scorers</a></li>
