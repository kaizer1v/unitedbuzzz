<?php
/*
Plugin Name: Activity Plugin (modified)
Plugin URI: http://google.com/
Description: A Facebook-style media sharing improvement for the activity box(modified according to our use).
Version: 199971.29
Author: Ankur Mantri
...
$BpfbInstaller = new BpfbInstaller();
